    ...
    <div className="fixed inset-0 z-[110] overflow-hidden">
      ...
      <div className="absolute top-0 bottom-0 left-0 w-full max-w-lg bg-white dark:bg-gray-950 shadow-3xl flex flex-col transition-transform duration-300 ease-in-out border-r border-gray-100 dark:border-gray-800">
        <div className="p-6 border-b border-gray-50 dark:border-gray-900 flex items-center justify-between">
          ...
          <button onClick={onClose} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-900 rounded-full transition-colors text-gray-400">
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-4">
          {cart.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-gray-400 space-y-6">
              ...
              <p className="font-black text-lg">عربة التسوق فارغة</p>
            </div>
          ) : (
            cart.map(item => {
              const product = products.find(p => p.id === item.productId);
              ...
              return (
                <div key={item.productId} className="flex gap-4 p-4 border border-gray-50 dark:border-gray-900 rounded-2xl bg-white dark:bg-gray-900/50 shadow-sm">
